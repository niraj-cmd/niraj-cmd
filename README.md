...
| ⌨️ **Windows Keyboard Event Monitoring Lab** | Windows API and keyboard-event monitoring research project using Python `ctypes` | [View Project](https://github.com/niraj-cmd/python-keylogger) |
...
<p>
  ...
  <img src="https://img.shields.io/badge/Windows%20API-000?style=flat&logo=windows">
  <img src="https://img.shields.io/badge/Scapy-000?style=flat">
  <img src="https://img.shields.io/badge/Netcat-000?style=flat">
  <img src="https://img.shields.io/badge/Red%20Team-000?style=flat">
  <img src="https://img.shields.io/badge/OSINT-000?style=flat">
  <img src="https://img.shields.io/badge/CTF-000?style=flat">
</p>
...
- 💻 Building beginner-friendly cybersecurity and red-team tools
...
The project loads Windows system libraries through Python:

user32 = ctypes.windll.user32
kernel32 = ctypes.windll.kernel32
2. Keyboard State

Virtual-key states are checked through:

user32.GetAsyncKeyState(vk)
3. State Tracking

The program tracks key state transitions:
...
</p> <p align="center"> 🚀 Red Team • Offensive Security • Windows Internals • Cybersecurity </p> <p align="center"> ⭐ If you find my projects useful, consider starring the repositories! </p> ```
